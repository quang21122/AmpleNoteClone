...
public class TasksPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskList.add(new Task("Task 1", "February 24th, 2025", "Created 23 minutes ago", false));
        taskList.add(new Task("Task 2", "February 25th, 2025", "Created 1 hour ago", true));
        // Thêm các task khác từ danh sách của user
